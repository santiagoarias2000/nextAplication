      ...
      <div className="lg:flex lg:items-center lg:justify-between mb-8">
        ...
        <div className="mt-5 flex lg:mt-0 lg:ml-4">
          <span className="sm:ml-3">
            <button
              type="button"
              className="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[#57bd9e] hover:bg-[#2ca880] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                  ...
                  {products?.map((product) => (
                    <tr key={`Product-item-${product.id}`}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <Link href={`/dashboard/edit/${product.id}`} className="text-gray-600 hover:text-gray-900">

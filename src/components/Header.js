...
export default function Header() {
  ...
  const userData = {
    //? this symbol (?) optional chaing
    name: auth?.user?.name,
    email: auth?.user?.email,
    //?https://ui-avatars.com/ this page is to be use the avatar api
    imageUrl: `https://ui-avatars.com/api/?name=${auth?.user?.name}/?background=#9089fc`,
  };
